...
In macOS, I use the OS settings to map `Control` to `CMD`.

This is my [Layer 0 - generated with Keyboard Layout Editor NG](https://editor.keyboard-tools.xyz/#share=-WfnrFbfltZoAPVcZO69UtZ-KVnml5DFzr0jhA0EcAO5FayZGgAUT0HCIAAN8uMDjFvDQYS0aAjUJNkWAAPquRQ45KFGTWLaFBwAQlchTpZJshX871WDgAlK4Uv8rECnsdOkyCZA0FsHCiub5--J1SgAxYsPlBwADVT29Bx+GvINbzU9S1QAIRfKMHAAOS-JEE3kdSNLgkCyUQlc4FwYQYBg-MEIpZcvJ89DaxErSaAALXw9s2JoAB+VwAHoqLsfVLXvOCO0AJMJRwCBxAETCad4n1bwZGc+waEABMJJNopMHEAZMI7hQMkUhoJAvAOCZ2pOPF8wBb99QpcyAGs9EoHjwBa+Y2rADqijiQp6wGhyVO-BwjwIZrYh-ebUEZXkerQQMfxWn85wpRiYCQbBtrmGJdvGSYGRoM6hrA8hOGYSa5qsR75SO-bXgSZo43emgcOwXyfum+R-ta2DQcGtaPLAFECEMFBwnCIA).

![Layer 0](KLENG-layer0.png)

Layer 1 is used with the Function key held down.

This is my [Layer 1 - generated with Keyboard Layout Editor NG](https://editor.keyboard-tools.xyz/#share=-AA6BAABjkBssYr4fn8AWAANSggC8kLGMmsTjyDmcITy6NQeRseUC5xm+JStys1kCRzWLTSTlhkDQKVchP8gQSrNQLho-FgzEi--nu7FgJmqvWFIyQfK9FRHWpWwdDsZA6GVX1qLkvTQYIaBAUFgDVOIYh7CcMmnOVXSVJkPiQ1xjFBcI1XqNtjyKB8Jh7bMvzQI1kLdMCfDtSDGTaWi6MuN1+yQ+J+IDNIIwne86JrD8Y1nfZ30jeEmJOEsZwEudqz-diaTsYMVVPOUzQAUQIAATTkAlY2sAHMAFVKG01BMODXwZCk+RXAACQQJhCPSadXBs1gCD2FAiRzMAkA46xBhoJBmmhRo7jE4MEVYRhsFCsYIqi-I4jyZ1kv+VL8OvSLYgjXLUExUk4oS-4IyK8SO1VMCwsUGJKoGIZixoJrUrKsL5C65w6uYgCeX6hlA0G5JhrigY0iSlqBtA8IgA).

![Layer 1](KLENG-layer1.png)

A few things to note:
* This layout is influenced by normal keyboards as well as the Kinesis layout.
* The `System` key (AKA Gui/Win) is placed where `CapsLock` normally is. This is a useless spot for `CapsLock` as that function is rarely used. In some keyboards such as the HHKB, this is mapped to `Control`. I have mapped it to `System`, as this is used far less than `Control`, which has been placed in the thumb cluster.
* Inner left thumb cluster keys, `Control` and `Alt`, resemble a similar location as the Kinesis layout.
* Inner right thumb cluster keys, `Enter` and `Space`, resemble a similar location as the Kinesis layout.
* The arrow keys resemble their location on the Kinesis layout but are one key position off.
* I map `F14` to a Linux shortcut to invoke hibernation.

**EDIT December 14, 2025:** After further testing—specifically using a flat layout of a similar hand-wired keyboard—I made adjustments to my keymap.
